...
class Logger
{
    ...
    /**
     * CORE method (write CORE message)
     * 
     * This is a custom method that is used for logging the core of the application.
     * Added: 10/01/2022
     * Added By: Marc Anderson, Trogy.
     * 
     * @param string $message Descriptive text of the debug
     * @param string $context Array to expend the message's meaning
     * @return void
     */
    public static function core($message, array $context = [])
    {
        // grab the line and file path where the log method has been executed ( for troubleshooting )
        $bt = debug_backtrace(DEBUG_BACKTRACE_PROVIDE_OBJECT, 1);
